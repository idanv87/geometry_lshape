...
class Constants:
    ...
    path = '/Users/idanversano/Documents/project_geo_deeponet/two_d_lshape/'
    eps_fig_path='/Users/idanversano/Documents/project_geo_deeponet/tex/figures/two_d_lshape/'
    ...
    isExist = os.path.exists(path+'base_polygons')
    if not isExist:
        os.makedirs(path+'base_polygons')    
